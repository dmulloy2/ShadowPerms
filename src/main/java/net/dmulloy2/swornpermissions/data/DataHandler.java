 ...
 * (c) 2014 dmulloy2
 */
package net.dmulloy2.swornpermissions.data;
...
import net.dmulloy2.swornpermissions.data.backend.MySQLBackend;
import net.dmulloy2.swornpermissions.data.backend.SQLiteBackend;
...
public class DataHandler implements Reloadable
{
	...
	public static Backend newBackend(BackendType type, SwornPermissions plugin)
	{
		switch (type)
		{
			case MY_SQL:
